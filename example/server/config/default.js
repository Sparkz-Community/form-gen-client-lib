...
module.exports = {
  ...
  appauth: {
    ...
    secret: lget(process.env, 'APPAUTH_SECRET', _APP_SECRET || ''),
    authStrategies: [
      'applocal',
      'jwt'
    ],
  ...
  userVault: {
    entity: 'vault',
    service: 'vaults',
    secret: lget(process.env, 'USERVAULT_SECRET', _APP_SECRET || ''),
    authStrategies: [
      'vaultWithApp'
    ],
    jwtOptions: {
  ...
  mailer: {
    ...
    logo: lget(process.env, 'MAILER_LOGO') || 'https://ha6755ad-images.s3-us-west-1.amazonaws.com/taxbox/taxbox_logo.png',
    mailgun: {
    ...
    sendgrid: {
      ...
      secure: true,
      auth: function () {
        if (lget(process.env, 'SENDGRID_API_USER') && lget(process.env, 'SENDGRID_API_KEY')) {
          return {
          ...
          return {
            user: lget(process.env, 'SENDGRID_USER', 'apikey'),
            pass: lget(process.env, 'SENDGRID_PASS', '')
          };
        }
      }(),
    },
  ...
  mongo: {
    uri: lget(process.env, 'MONGO_DB_URI', 'mongodb://test:test@localhost/test?retryWrites=true&w=majority'),
    options: {
