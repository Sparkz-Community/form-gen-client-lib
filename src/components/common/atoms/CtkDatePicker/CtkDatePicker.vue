<template>
  <transition v-bind="attrs['transition-attrs']">
    <div id="CtkDatePicker" v-bind="attrs['div-attrs']">
      <q-field :modelValue="modelValue"
               v-bind="attrs['q-field-attrs']"
               @clear="$emit('update:modelValue', undefined)">
        <template v-slot:control>
          <VueCtkDateTimePicker ref="VueCtkDateTimePicker" :modelValue="modelValue" @update:modelValue="$emit('update:modelValue', $event)" v-bind="attrs['attrs']">
...
<style lang="scss" src="./_CtkDatePicker.scss">
</style>
